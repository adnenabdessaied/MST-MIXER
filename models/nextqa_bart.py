...
from .utils import ELBO, embed_graphs, diag_tensor, track_features_text, track_features_vis, get_knn_graph, seperate_nextqa_input_modalities
            ...
            if self.training and (dropout_probability < self.layerdrop):  # skip the layer
                ...
                if self.gradient_checkpointing and self.training:
                    ...
                    if idx % self.config.gnns_every == 0 or idx == len(self.layers) - 1:
                        ...
                        features, att = seperate_nextqa_input_modalities(
                            hidden_states,
                            i3d_rgb_interval,
                            i3d_flow_interval,
                            question_intervals,
                        ...
                        i3d_rgb_hidden, i3d_flow_hidden, question_hidden = features
                        i3d_rgb_att, i3d_flow_att, question_att = att
                        ...
                        X = [i3d_rgb_X, i3d_flow_X, question_X]
                        ...
                        for sv, idx in zip(state_vectors[:2], vis_state_vector_idx):  # Only the visual state vectors
                        ...
                        hidden_states = hidden_states.scatter(1, question_state_vector_idx_expanded, state_vectors[2].unsqueeze(0))

                        if self.config.integrate_all_gnn_features:                           
                            # Now integrate the GNN node features into the hidden states
                            vis_node_idx = [i3d_rgb_node_idx, i3d_flow_node_idx]
